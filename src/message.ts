 ...
 */
export type MessageSchema<T extends object = {}> = { [property in keyof T]: Message; };
 ...
 * @param value
 */
export const isMessageSchema = (value: any): value is MessageSchema<any> => value && typeof value === 'object';
